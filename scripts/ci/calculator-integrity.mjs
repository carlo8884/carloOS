...
const CALCULATORS = [
  ...
  },
  {
    ...
    mustInclude: [
      ...
      { re: /amazon-brand\/ferret\+nation\+critter\+nation\+double\+unit\?s=tools-cage-size-calculator/, label: 'multi-level cage search hop' },
      ...
      { re: /amazon-brand\/compressed\+wood\+pellet\+litter\+heat\+treated\+non\+clumping\?s=tools-cage-size-calculator/, label: 'wood pellet litter search hop' },
      { re: /amazonHref="\/go\/amazon-brand\//, label: 'ShopCtas amazon-brand hops only' },
    ],
    mustExclude: [
      { re: /amazonHref=["']#["']/, label: 'never href="#"' },
