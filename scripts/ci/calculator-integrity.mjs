...
const CALCULATORS = [
  ...
  },
  {
    ...
    mustInclude: [
      ...
      { re: /amazon-brand\/letter\+size\+accordion\+file\+organizer\?s=health-senior-bloodwork-guide/, label: 'letter-size accordion file-organizer search hop (matches on-page dated CBC / chemistry / UA printout trend copy; unique vs pet+medical+records+binder / pet+vaccination+record+book / waterproof+field+notebook / dog+weight+log+book)' },
      { re: /amazon-brand\/sterile\+urine\+specimen\+cup\?s=health-senior-bloodwork-guide/, label: 'sterile urine specimen-cup search hop (matches on-page free-catch UA / appointment-sample copy; unique vs fecal+sample+collection+kit / leak+proof+specimen+bags / equine+fecal+sample+container)' },
      { re: /amazon-brand\/magnetic\+kitchen\+memo\+board\?s=health-senior-bloodwork-guide/, label: 'magnetic kitchen memo-board search hop (matches on-page overnight-fast / glucose-and-chemistry copy; unique vs dry+erase+monthly+calendar / one+minute+kitchen+timer / analog+bathroom+scale)' },
      { re: /amazonHref="\/go\/amazon-brand\//, label: 'ShopCtas amazon-brand hops only' },
    ],
    mustExclude: [
      { re: /amazonHref=["']#["']/, label: 'never href="#"' },
      ...
      { re: /chewyHref|chewy-brand|\/go\/chewy/, label: 'omit Chewy so empty hops stay hidden' },
      { re: /ctaText="Subscribe"/, label: 'never generic Subscribe' },
      { re: /amazon-brand\/[^?"']*(wire\+small\+animal\+single\+story\+cage|non\+slip\+suction\+bathtub\+mat|stainless\+steel\+small\+animal\+crock|extra\+small\+animal\+travel\+kennel|scent\+swap\+fleece\+sleep\+pouch|portable\+small\+animal\+playpen|small\+animal\+rabies\+certificate\+holder|top\+loading\+small\+animal\+carrier|fleece\+small\+animal\+bonding\+pouch|carnivore\+care\+critical\+care\+formula|chicken\+meat\+baby\+food|silicone\+tip\+oral\+dosing\+syringe|equine\+slow\+feeder\+hay\+box|nylon\+equine\+stall\+guard|hemp\+equine\+stall\+bedding|topical\+equine\+thrush\+antiseptic|folding\+pocket\+equine\+hoof\+pick|equine\+stall\+sweet\+lime|equine\+foam\+sole\+support\+pads|equine\+deep\+sand\+stall\+bedding|easy\+keeper\+grazing\+muzzle|equine\+digital\+rectal\+thermometer|large\+animal\+stethoscope|soft\+fleece\+equine\+cooler|equine\+farrier\+log\+book|portable\+farrier\+hoof\+stand|cordless\+barn\+flood\+light|equine\+fecal\+sample\+container|pasture\+manure\+rake|stable\+muck\+cart|adjustable\+sliding\+dog\+food\+scoop|reusable\+dog\+food\+portion\+cups|dog\+weight\+log\+book|digital\+handheld\+stopwatch|waterproof\+field\+notebook|foam\+table\+edge\+bumper|automatic\+timed\+dog\+feeder|maze\+slow\+feed\+dog\+bowl|indoor\+dog\+house\+line|disposable\+female\+dog\+diapers|inflatable\+dog\+collar|hard\+sided\+airline\+dog\+crate|pet\+medical\+records\+binder|pet\+vaccination\+record\+book|pet\+emergency\+contact\+card|fecal\+sample\+collection\+kit|leak\+proof\+specimen\+bags|dry\+erase\+monthly\+calendar|one\+minute\+kitchen\+timer|resting\+respiratory\+rate\+notebook|am\+pm\+weekly\+pill\+organizer|monthly\+pill\+organizer|digital\+pet\+scale|digital\+hanging\+luggage\+scale|analog\+bathroom\+scale|kitchen\+gram\+scale|kitchen\+measuring\+cup|heavy\+ceramic\+pet\+food\+bowl|ceramic\+pet\+food\+bowl|ferret\+nation\+critter\+nation\+double\+unit|ferret\+carrier|soft\+pet\+carrier|soft\+sided\+vet\+visit\+carrier|pet\+glucometer|light\+corn\+syrup|pet\+oral\+feeding\+syringe|insulin|vetsulin|soloxine|thyro\+tabs|synthroid|levothyroxine|trilostane|vetoryl|hills|hill\+s|royal\+canin|prescription|medication|medicine|rx\b|ibuprofen|acetaminophen|naproxen)/, label: 'never hop #1069 wire-cage / bathtub-mat / stainless-crock, #1068 travel-kennel / scent-swap-pouch / portable-playpen, #1067 rabies-certificate-holder / top-loading-carrier / bonding-pouch, #1066 carnivore-care / baby-food / silicone-dosing-syringe, #1065 hay-box / stall-guard / hemp-bedding, #1059 scoop / portion-cups / weight-log-book, #1058 stopwatch / field-notebook / table-bumper, #1057 timed-feeder / maze-bowl / house-line, pet-medical-records-binder / pet-vaccination-record-book, fecal-sample-collection-kit / leak-proof-specimen-bags, dry-erase-monthly-calendar / one-minute-kitchen-timer, pet-glucometer / light-corn-syrup / pet-oral-feeding-syringe, ferret-carrier / ceramic-pet-food-bowl / Critter-Nation-double, insulin / levothyroxine / Vetoryl, Hill\'s / Royal Canin, or Rx — this page hops only letter-size-accordion-file-organizer / sterile-urine-specimen-cup / magnetic-kitchen-memo-board gear' },
    ],
    why: 'Money path: keep the existing sidebar capture; under-hero capture with a concrete senior-dog bloodwork visit-checklist offer; every gear CTA is an amazon-brand category search matching on-page panel-trend / free-catch UA / overnight-fast copy (a letter-size accordion file organizer so dated CBC / chemistry / UA printouts stay in one chronological trend, a sterile urine specimen cup so a free-catch sample can travel with the appointment, a magnetic kitchen memo board so the overnight fast before glucose and chemistry is written where the household can see it), never a placeholder ASIN, a #1069 wire-cage / bathtub-mat / stainless-crock hop, a #1068 travel-kennel / scent-swap-pouch / portable-playpen hop, a pet-glucometer / light-corn-syrup hop, a pet-vaccination-record-book / pet-medical-records-binder hop, a ferret-carrier / ceramic-pet-food-bowl / Critter-Nation-double hop, or a medication hop. Chewy stays omitted so empty buttons stay hidden.',
  },
]
