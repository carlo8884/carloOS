...
Carlo offline until next week. Recap logged here (Gmail write scopes insufficient / recipient unknown). Next hour: re-check fish visual edge cases or horses homepage spacing if drift appears.
