...
|---|---|---|---|
| COO | 2026-05-30 | 🟡 baseline | Docs (`STATUS`/`DASHBOARD`) claim 15 apps; `apps/` has 10. Drift flagged via `csro-dir-2026-W22-002`. |
| Monetization Bot | — | ⚪ no data | No recent monetization handoffs in `ops/handoffs/`. |
