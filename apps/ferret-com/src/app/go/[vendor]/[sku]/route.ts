/**
 * /go/[vendor]/[sku] — affiliate click-tracking redirect (Ferret.com).
 *
 * Looks up the vendor in apps/ferret-com/src/data/affiliate-routes.ts, fills
