...
export const metadata: Metadata = {
  ...buildMetadata({
    siteId: 'ferret-com',
    title: 'Apply for an exotic-mammal professional page',
    description:
      'Exotic-mammal professionals can apply for a claimed profile on Ferret.com. Approval is manual.',
    path: '/join/pro',
    type: 'article',
  }),
      ...
      <div className="carloOS-article">
        ...
        <div className="not-prose max-w-md my-6">
          <EmailCapture
            variant="section"
            siteId="ferret-com"
            title="When claimed exotic vets have a page"
            subtitle="Owners only. One email when an accepted professional page exists. Use the application form if you treat exotics."
