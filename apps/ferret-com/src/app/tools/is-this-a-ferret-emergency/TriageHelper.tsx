...
/**
 * "Is This a Ferret Emergency?" triage helper -- /tools/is-this-a-ferret-emergency
 *
 ...
 * data/ferret-symptom-signs. It is a triage AID, NOT a diagnosis tool.
 *
 ...
 *   - ONLY monitor-eligible signs (11/12) -> MONITOR CLOSELY (neutral) +
...
function deriveVerdict(selected: Set<string>): Verdict | null {
  ...
  if (hasEmergency) {
    return {
      tier: 'go-now',
      eyebrow: 'Go now',
      headline: 'These signs can be a life-threatening emergency. Go to a ferret-capable emergency vet now.',
      lead: `Do not wait for another symptom. If you cannot reach a clinic, or you suspect poisoning, call ASPCA Animal Poison Control at ${ASPCA} on the way. Ferrets hide illness and crash fast. When in doubt, seek care now.`,
    }
  }

  // No emergency signs selected -> everything is urgent.
  // MONITOR only if EVERY selected sign is monitor-eligible (11/12).
  ...
  if (allMonitorEligible) {
    return {
      ...
      lead: 'For a single mild sneeze, or one skipped meal in an otherwise bright, energetic ferret that is still drinking, watching closely for a short window can be reasonable. Call your exotic-mammal vet — or the nearest ferret-capable emergency clinic — if it persists, worsens, repeats, or you are unsure. Ferrets escalate faster than dogs. When in doubt, seek care now.',
    }
  }
  ...
  return {
    ...
    headline: 'See an exotic-mammal vet today — sooner if it worsens.',
    lead: `These signs warrant veterinary attention within 24 hours, or sooner if anything worsens. If you are unsure, call your exotic-mammal vet or your nearest ferret-capable emergency clinic now — when in doubt, seek care now.`,
  }
}
      ...
      <div className="lg:sticky lg:top-6" aria-live="polite" aria-atomic="true">
        {!verdict && (
          <div className="rounded-xl border border-brand-border bg-brand-white p-6">
            ...
            <p className="text-sm text-brand-text-mid leading-relaxed m-0">
              ...
              exotic-mammal vet or your nearest ferret-capable emergency clinic — this tool helps you decide
              how urgently to seek care, it does not diagnose your ferret.
            </p>
          </div>
        )}
        ...
        <div className="mt-4 rounded-lg border border-brand-border bg-brand-surface p-4">
          <p className="text-xs text-brand-text-light leading-relaxed m-0">
            ...
            decide how urgently to seek care. It does not diagnose your ferret — only a veterinarian can. If you
            are ever unsure, treat it as urgent and call your exotic-mammal vet or emergency clinic.
          </p>
        </div>
      </div>
    </div>
