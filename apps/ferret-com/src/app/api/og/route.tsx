/**
 * GET /api/og?title=...&category=...&site=ferret-com
...
export async function GET(req: NextRequest) {
  ...
  const title = searchParams.get('title') ?? 'A Reference for Ferret Owners'
  const category = searchParams.get('category') ?? ''
  const siteId = (searchParams.get('site') ?? 'ferret-com') as keyof typeof SITE_CONFIGS
  const site = SITE_CONFIGS[siteId] ?? SITE_CONFIGS['ferret-com']
