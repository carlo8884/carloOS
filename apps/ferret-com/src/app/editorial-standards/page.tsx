...
export const metadata: Metadata = buildMetadata({
  siteId: 'ferret-com',
  title: 'Editorial Standards | Ferret.com',
  description: 'Ferret.com editorial standards — how we research, source, and review our content.',
...
const breadcrumbSchema = buildBreadcrumbSchema({
  items: [
    ...
    { name: 'Editorial Standards', url: 'https://ferret.com/editorial-standards' },
  ],
})
...
export default function EditorialStandardsPage() {
  ...
  return (
    <div className="px-container-sm sm:px-container py-16 max-w-content mx-auto">
      ...
      <p>Ferret.com is a reference publication. The editorial standards below explain how we research, source, fact-check, and disclose interests. They are the same standards that govern every CarloOS-family site.</p>
      ...
      <p>Ferret.com does not own equity in any brand it reviews. Affiliate commercial relationships with named vendors are disclosed on every affected page and centrally on <Link href="/disclosure" className="text-brand-primary no-underline hover:underline">/disclosure</Link>.</p>
