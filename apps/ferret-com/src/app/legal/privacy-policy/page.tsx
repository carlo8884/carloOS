...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="px-container-sm sm:px-container py-16 max-w-content mx-auto">
      ...
      <p>Ferret.com is owned and operated by Bolton Properties, LLC. This page describes how we collect, use, and protect information from visitors. We respect your privacy and limit collection to what is necessary to operate the site.</p>
      ...
      <h2>Cookies</h2>
      <p>Ferret.com uses cookies for analytics and to remember non-essential preferences (e.g., dismissed banners). You can disable cookies in your browser settings without losing access to the site’s content.</p>

      <h2>Affiliate Disclosure</h2>
      <p>Ferret.com participates in affiliate programs. When you click an affiliate link and make a purchase, we may earn a commission at no additional cost to you. See our <Link href="/disclosure" className="text-brand-primary no-underline hover:underline">full affiliate disclosure</Link> for details.</p>
