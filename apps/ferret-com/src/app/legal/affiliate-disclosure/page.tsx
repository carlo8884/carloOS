  ...
  return (
    <div className="px-container-sm sm:px-container py-16 max-w-content mx-auto">
      ...
      <div className="carloOS-article">
        ...
        <h2>How It Works</h2>
        <ul>
          <li>Some product links on Ferret.com are affiliate links. You can identify them by the disclosure label on or near the link (typically &quot;Affiliate link&quot;, an affiliate-link icon, or a section-level disclosure at the top of the page).</li>
        ...
        <ul>
          <li><strong>Rankings are made first, affiliate links added second.</strong> We decide what to include and how to rank it based on editorial criteria. Affiliate links are added afterward to whichever products pass that filter.</li>
          ...
          <li><strong>We do not monetize medical products.</strong> Prescription, medicated, or clinical products are never affiliate links — those are matters for your veterinarian, not commerce.</li>
        ...
        <p>Ferret.com is a participant in the following affiliate programs: Amazon Associates, Chewy, and other pet-supply retailers. We may add or remove programs over time and will update this page accordingly. Adding a new affiliate program never retroactively changes existing rankings.</p>

        <h2>Questions</h2>
        <p>If you spot a missing disclosure, an outdated affiliate link, or anything that looks like editorial bias toward a specific product or brand, please email legal@ferret.com.</p>
      </div>
