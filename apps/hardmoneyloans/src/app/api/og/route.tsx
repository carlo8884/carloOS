 ...
 * hardmoneyloans. Edge runtime keeps response latency low globally.
 *
...
export async function GET(req: NextRequest) {
  ...
  const title = searchParams.get('title') ?? 'Hard Money Loans, Explained'
