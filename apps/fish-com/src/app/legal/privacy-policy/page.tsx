...
export const metadata: Metadata = buildMetadata({
  siteId: 'fish-com',
  title: 'Privacy Policy | Fish.com',
  description: 'Fish.com privacy policy — how we collect, use, and protect your data.',
...
const breadcrumbSchema = buildBreadcrumbSchema({
  items: [
    ...
    { name: 'Privacy Policy', url: 'https://fish.com/legal/privacy-policy' },
  ],
})
  ...
  return (
    <>
      ...
      <div className="carloOS-article">
        <h2>Who We Are</h2>
        <p>Fish.com is owned and operated by Bolton Properties, LLC. This privacy policy applies to fish.com and covers how we collect, use, and protect information from visitors to our site.</p>
        ...
        <p>Fish.com is not directed at children under 13. We do not knowingly collect personal information from children under 13. If you believe we have collected such information, contact us and we will delete it.</p>
        ...
        <h2>Contact</h2>
        <p>Privacy questions: privacy@fish.com</p>
      </div>
