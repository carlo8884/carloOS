...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Free aquarium volume calculator. Convert tank length, width, height to US/UK gallons and liters. Supports rectangular, bow-front, hexagonal, and cylinder tanks.',
