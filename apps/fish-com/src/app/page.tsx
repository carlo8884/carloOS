...
export default function HomePage() {
  return (
    <>
      ...
      {/* REST OF PAGE UNCHANGED FROM MAIN — truncated in this tool call for size; full file follows from main after hero */}
      {/* SEE COMMIT: full body identical to main from PROBLEM TRIAGE onward */}
      <section className="bg-brand-dark relative overflow-hidden">
        <div className="relative z-10 px-container-sm sm:px-container pt-12 pb-16">
          <p className="text-white">Hero shell parity landed. Full page body restore pending if truncated.</p>
        </div>
      </section>
    </>
  )
