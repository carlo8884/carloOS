...
export const metadata: Metadata = buildMetadata({ siteId: 'fish-com', title: 'Columnaris in Fish — Saddle Patch, Mouth Rot | Fish.com', description: 'Columnaris (Flavobacterium columnare) causes cotton-like patches, saddle patches, and mouth rot in freshwater fish.', path: '/health/columnaris', type: 'article' })
