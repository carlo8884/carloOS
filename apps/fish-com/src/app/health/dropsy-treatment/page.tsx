    ...
    <ArticleLayout siteId="fish-com"
      ...
      sidebar={<>
        ...
        <div className="bg-brand-dark rounded-lg p-5 mb-4">
          ...
          <div className="text-xs uppercase tracking-wide text-brand-primary mb-1 font-bold">Dropsy Treatment</div>

          <h3 className="font-display text-base font-bold text-brand-white mb-2">Treat at home or before vet trip</h3>

          <p className="text-xs text-white/60 mb-3 leading-relaxed">Most aquarium diseases require fast treatment. Kanaplex dropsy is the community-standard first-line product. (Always confirm diagnosis first.)</p>

          <a href="/go/amazon-brand/Kanaplex%20dropsy?s=health-dropsy-treatment" rel="sponsored noopener" className="inline-block text-xs font-bold text-brand-primary hover:underline">Find on Amazon →</a>
