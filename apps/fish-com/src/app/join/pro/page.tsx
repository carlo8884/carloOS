...
export const metadata: Metadata = {
  ...buildMetadata({
    siteId: 'fish-com',
    title: 'Apply for an aquarium professional page',
    description:
      'Aquarium professionals can apply for a claimed profile on Fish.com. Approval is manual.',
    path: '/join/pro',
    type: 'article',
  }),
      ...
      <div className="carloOS-article">
        ...
        <div className="not-prose max-w-md my-6">
          <EmailCapture
            variant="section"
            siteId="fish-com"
            title="When claimed aquarium shops have a page"
            subtitle="Owners only. One email when an accepted professional page exists. Use the application form if you run a shop."
