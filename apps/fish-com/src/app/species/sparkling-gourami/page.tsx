...
const FAQS = [
  {
    question: 'Do sparkling gouramis really make sound?',
    answer:
      'Yes. The sparkling gourami produces an audible croaking or purring noise generated by specialized pectoral-fin tendons that snap against the body during courtship, territorial disputes, and general excitement. In a quiet room the sound from a confident group is clearly perceptible from outside the tank. The croaking is most pronounced when the fish feel secure, so it doubles as a welfare indicator — a silent, hiding fish is usually stressed.',
    answerText:
      'Yes — they croak using pectoral-fin tendons that snap against the body. The sound is clearest when the fish feel secure, so it doubles as a welfare indicator.',
  },
  {
    question: 'What size tank do sparkling gouramis need?',
    answer:
      'A planted 10-gallon tank comfortably houses a small group. At well under an inch and a half, the sparkling gourami is a true nano species. It is shy and easily intimidated, so the tank should be quiet, densely planted, and free of boisterous or fin-nipping tankmates.',
    answerText:
      'A planted 10-gallon tank houses a small group. At under 1.5 inches it is a true nano species and needs a quiet, densely planted tank without boisterous tankmates.',
  },
  {
    question: 'Should sparkling gouramis be kept in a group?',
    answer:
      'They are bolder and more vocal in a group of four to six. A single specimen often stays hidden, while a small colony interacts, displays, and croaks far more readily. Good tankmates are small rasboras, pygmy corydoras, and dwarf shrimp.',
    answerText:
      'Yes — they are bolder and more vocal in a group of four to six. A lone fish hides; a colony displays and croaks more readily.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Like the betta and pearl gourami, it is a labyrinth fish that breathes atmospheric air at the surface, so it needs unobstructed surface access and warm, humid air above the waterline. A lid that traps cold room air directly over the water can chill the gulped air and harm the labyrinth organ.',
    answerText:
      'It is a labyrinth fish that breathes air at the surface and needs unobstructed access plus warm, humid air above the water. Cold trapped air can harm the labyrinth organ.',
  },
]
