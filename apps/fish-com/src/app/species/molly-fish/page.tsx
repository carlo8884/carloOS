...
export const metadata: Metadata = buildMetadata({ siteId: 'fish-com', title: 'Molly Fish Care Guide — Brackish Tolerance | Fish.com', description: 'Mollies are livebearers that tolerate salt — adding 1 tablespoon per 5 gallons reduces disease and stress. Black molly, sailfin molly.', path: '/species/molly-fish', type: 'article' })
