...
export default function MollyPage() {
  return (
    <ArticleLayout siteId="fish-com"
      hero={{ title: 'Molly Fish Care Guide', subtitle: 'Poecilia sphenops and Poecilia latipinna — mollies are livebearing fish native to coastal areas of the Americas where freshwater meets the sea, giving them an unusual tolerance for brackish (lightly salted) water that reduces disease and stress. Available in dozens of color varieties and distinctively shaped forms including the sailfin molly with its dramatic extended dorsal fin.', category: 'Species Guide', authorName: 'Fish.com Expert Team', authorAvatar: '🐠', publishedAt: 'May 2025', readTime: '8 min' }}
