...
const FAQS = [
  {
    question: 'How many ember tetras should I keep together?',
    answer:
      'Keep a minimum of 10, with 20 or more producing the best display. A large group moving together through a planted scape creates the "school of fire" effect. They are active and confident in groups, but more reclusive and less colorful when kept in small numbers.',
    answerText:
      'Keep at least 10 ember tetras, with 20+ for the best display. They are confident in groups and reclusive and less colorful in small numbers.',
  },
  {
    question: 'Are ember tetras safe with shrimp?',
    answer:
      'Yes — ember tetras are one of the few fish reliably safe with cherry shrimp colonies, including shrimplets. At 0.8 inches they cannot eat adult cherry shrimp, and their drive toward tiny prey appears limited; most aquarists report them ignoring shrimp completely. They are a popular choice for shrimp-focused planted tanks that want some fish movement.',
    answerText:
      'Yes. At 0.8 inches ember tetras cannot eat adult cherry shrimp and most keepers report them ignoring shrimp completely, making them popular for shrimp tanks.',
  },
  {
    question: 'What size tank do ember tetras need?',
    answer:
      'A 5-gallon tank is the minimum, with 10 or more gallons recommended so a larger school has room for the full display. Because they are only 0.8 inches, a 20-gallon tank can hold a sizeable school that suggests a much larger setup.',
    answerText:
      'A 5-gallon minimum, with 10+ gallons recommended. At 0.8 inches, a 20-gallon tank holds a large school in a small footprint.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Very small foods, matched to their tiny mouth: finely crushed micro pellets, micro-size live foods such as micro worms and baby brine shrimp, and very small flake. They compete well within their size class but are outcompeted by larger, faster fish, so keep them with similarly sized species or feed near the bottom where they forage.',
    answerText:
      'Feed very small foods: crushed micro pellets, micro worms, baby brine shrimp, and small flake. They are outcompeted by larger fish, so keep with similarly sized species.',
  },
]
