...
const FAQS = [
  {
    ...
    answer:
      'At least six, with eight to ten producing better behavior. Kept singly or in pairs, zebra danios become stressed and frequently turn into relentless fin-nippers — much of the danio "aggression" reported by keepers stems from understocked groups. In a proper school, intra-group chasing replaces harassment of tankmates.',
    answerText:
      'At least six; eight to ten is better. Singly or in pairs they become stressed and often fin-nip. In a proper school, chasing stays within the group.',
  },
  {
  ...
  {
    question: 'What tank size do zebra danios need?',
    answer:
      'A 10-gallon tank is the minimum, with a 20-gallon long ideal — these are fast, constantly moving fish that occupy the top and middle of the water column. A tight-fitting lid is non-negotiable: danios are exceptional jumpers that will leap through filter cutouts and uncovered feeding holes.',
    answerText:
      '10 gallons minimum, 20 long ideal. A tight-fitting lid is essential — danios are exceptional jumpers.',
  },
  {
    question: 'Are zebra danios fin-nippers?',
    answer:
      'Mainly when understocked. In groups of six or more, chasing stays within the school. Their constant motion still makes them unsuitable tankmates for slow, long-finned fish such as bettas or fancy goldfish, whose fins they may nip and whose food they will outcompete.',
    answerText:
      'Mainly when understocked. In groups of 6+ chasing stays within the school, but avoid pairing them with slow, long-finned fish like bettas or fancy goldfish.',
  },
  {
    question: 'How do zebra danios breed?',
    answer:
      'They are egg-scatterers and among the easiest egg-layers to breed. A well-conditioned group spawns at first light, scattering non-adhesive eggs that fall to the bottom. Because adults eagerly eat their own eggs, breeders use a layer of marbles or mesh on the tank floor. Eggs hatch in two to three days; fry need infusoria or liquid fry food until large enough for baby brine shrimp.',
    answerText:
      'Egg-scatterers that spawn at first light. Adults eat their own eggs, so breeders use marbles or mesh on the tank floor. Eggs hatch in 2-3 days.',
  },
]
