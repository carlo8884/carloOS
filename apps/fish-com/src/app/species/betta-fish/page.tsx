...
<<<<<<< HEAD
    ...
    >
      <div className="carloOS-article">
        ...
        <DropCap letter="B">Bettas (Betta splendens) need a heated, filtered tank of at least 5 gallons held at 76–82°F — not a bowl or vase. They are carnivores: feed a high-protein betta-specific pellet (Northfin Betta Bits, NLS Betta Formula) plus frozen bloodworms or daphnia 3–4 times weekly, not flake. Males cannot share a tank. With correct heat, filtration, and diet, bettas live 3–5 years and display vivid color, recognition of their owner, and learned behavior.</DropCap>

        <CalloutBox variant="tip" title="Tank size — the real minimum">
          A 5-gallon heated, filtered tank is the realistic minimum for a betta to thrive. A 10-gallon planted tank is meaningfully better: more stable temperature, more enrichment, more swimming distance. Bowls and vases are not adequate housing — they are why most pet-store bettas die before two years.
        </CalloutBox>
