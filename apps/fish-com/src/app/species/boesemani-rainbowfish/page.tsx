...
export default function BoesemaniPage() {
  return (
    <ArticleLayout siteId="fish-com"
      hero={{ title: 'Boesemani Rainbowfish', subtitle: 'Melanotaenia boesemani — the flagship rainbowfish of the aquarium hobby, named after Dr. Marinus Boeseman who first described the species. The split-color pattern — vivid blue-purple on the anterior half, deep orange-red on the posterior — makes Boesemani one of the most photogenic fish in freshwater. Males in peak condition display to each other constantly, intensifying both colors.', category: 'Species Guide', authorName: 'Fish.com Expert Team', authorAvatar: '🐠', publishedAt: 'May 2025', readTime: '8 min' }}
