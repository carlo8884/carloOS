/**
 * /go/[vendor]/[sku] — affiliate click-tracking redirect (Ferrets.com).
 *
 * Looks up the vendor in apps/ferrets-com/src/data/affiliate-routes.ts, fills
