/**
 * GET /api/og?title=...&category=...&site=ferrets-com
...
export async function GET(req: NextRequest) {
  ...
  const title = searchParams.get('title') ?? 'The Ferret Owner\'s Library'
  const category = searchParams.get('category') ?? ''
  const siteId = (searchParams.get('site') ?? 'ferrets-com') as keyof typeof SITE_CONFIGS
  const site = SITE_CONFIGS[siteId] ?? SITE_CONFIGS['ferrets-com']
