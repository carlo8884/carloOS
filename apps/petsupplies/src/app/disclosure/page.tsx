...
export const metadata: Metadata = buildMetadata({
  siteId: 'petsupplies',
  title: 'Affiliate Disclosure — PetSupplies.com',
  description: 'Editorial integrity policy and FTC affiliate disclosure for PetSupplies.com.',
  path: '/disclosure',
  type: 'article',
})
  ...
  return (
    <main className="min-h-screen bg-brand-white py-16">
      <div className="max-w-content mx-auto px-container">
        ...
        <AffiliateDisclosure variant="page" siteId="petsupplies" />
      </div>
    </main>
  )
}
