...
/**
 * "Is This a Horse Emergency?" triage helper -- /tools/is-this-a-horse-emergency
 *
 ...
 * data/horse-symptom-signs. It is a triage AID, NOT a diagnosis tool.
 *
 ...
 *   - ONLY monitor-eligible signs (09/10) -> MONITOR CLOSELY (neutral) +
...
function deriveVerdict(selected: Set<string>): Verdict | null {
  ...
  if (hasEmergency) {
    return {
      tier: 'go-now',
      eyebrow: 'Go now',
      headline: 'These signs can be a life-threatening emergency. Call your equine veterinarian now.',
      lead: `Do not wait for another symptom. If you cannot reach your regular vet, call the nearest equine emergency clinic. If you suspect poisoning, call ASPCA Animal Poison Control at ${ASPCA} on the way. When in doubt, seek care now.`,
    }
  }

  // No emergency signs selected -> everything is urgent.
  // MONITOR only if EVERY selected sign is monitor-eligible (09/10).
  ...
  if (allMonitorEligible) {
    return {
      ...
      lead: 'For an isolated mild scrape, or one skipped handful of grain in an otherwise bright horse with normal manure and energy, watching closely for a short window can be reasonable. Call your equine veterinarian — or the nearest equine emergency clinic — if it persists, worsens, repeats, or you are unsure. When in doubt, seek care now.',
    }
  }
  ...
  return {
    ...
    headline: 'See an equine veterinarian today — sooner if it worsens.',
    lead: `These signs warrant veterinary attention within 24 hours, or sooner if anything worsens. If you are unsure, call your equine veterinarian or your nearest equine emergency clinic now — when in doubt, seek care now.`,
  }
}
      ...
      <div className="lg:sticky lg:top-6" aria-live="polite" aria-atomic="true">
        ...
        <div className="mt-4 rounded-lg border border-brand-border bg-brand-surface p-4">
          <p className="text-xs text-brand-text-light leading-relaxed m-0">
            ...
            decide how urgently to seek care. It does not diagnose your horse — only a veterinarian can. If you
            are ever unsure, treat it as urgent and call your equine veterinarian or emergency clinic.
          </p>
        </div>
      </div>
    </div>
