...
const TOOLS = [
  {
    ...
    desc: 'Check equine signs — classic colic red flags (rolling, looking at the flank, no manure, high heart rate, severe pain), choke, non-weight-bearing lameness, heavy bleeding, down and cannot rise, gum color, laminitis/founder — for a conservative go-now / same-day / monitor read. A sign-list triage aid, not a diagnosis.',
    tag: 'Triage',
  },
  {
    href: '/tools/horse-grimace-scale',
    title: 'Horse Grimace Scale',
    desc: 'Is your horse in pain? Score five facial signs — ears, eyes, brow, chewing muscles / mouth, nostrils — on this owner Equine Grimace checklist. Planning / observation reference, not a diagnosis. High-pain faces go to emergency triage first, not a shopping list.',
    tag: 'Health',
  },
  {
      ...
      <section className="bg-brand-surface px-container-sm sm:px-container py-section">
        ...
        <div className="my-6 p-5 border border-brand-border rounded-xl bg-brand-surface not-prose max-w-content-wide">
          ...
          <div className="flex flex-col gap-3">
            <ShopCtas
              amazonHref="/go/amazon-brand/horse+supplies?s=tools-hub"
