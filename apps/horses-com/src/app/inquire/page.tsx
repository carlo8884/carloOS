...
export const metadata: Metadata = {
  ...buildMetadata({
    ...
    title: 'Inquiries',
    description:
      'Acquisition and partnership inquiries for Horses.com. The site is an operating editorial property.',
    path: '/inquire',
    type: 'article',
  }),
  ...
  return (
    <ArticleLayout
      ...
      hero={{
        title: 'Inquiries',
        subtitle:
          'Horses.com is an operating editorial site. Serious acquisition and partnership notes are welcome. There is no public asking price on this page.',
        category: 'Site',
    ...
    >
      <div className="carloOS-article">
        <p>
          ...
          operations continue either way. horse.com (the Shopify store) is a
          separate property.
        </p>
        ...
        {inquireEmail ? (
          <p>
            Send that to{' '}
            <a href={`mailto:${inquireEmail}?subject=Horses.com inquiry`}>
              {inquireEmail}
            </a>
            .
          </p>
