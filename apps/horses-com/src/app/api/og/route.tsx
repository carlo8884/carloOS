/**
 * GET /api/og?title=...&category=...&site=horses-com
...
export async function GET(req: NextRequest) {
  ...
  const title = searchParams.get('title') ?? 'A Reference for Horse Owners'
  const category = searchParams.get('category') ?? ''
  const siteId = (searchParams.get('site') ?? 'horses-com') as keyof typeof SITE_CONFIGS
  const site = SITE_CONFIGS[siteId] ?? SITE_CONFIGS['horses-com']
