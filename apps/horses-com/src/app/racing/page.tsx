/**
 * Horses.com Race Center — /racing
 *
 * Content-only page (Nav/Footer/main come from layout.tsx). Surfaces today's
 * AI verdicts and meetings using the explainable Horses.com Intelligence
 * Rating engine. Phase-1 curated data; live feed swaps in via RacingDataSource.
 */
...
export default function RaceCenterPage() {
  ...
  return (
    <>
      <Breadcrumb siteId="horses-com" items={[{ label: 'Home', href: '/' }, { label: 'Race Center' }]} />
