/**
 * /go/[vendor]/[sku] — affiliate click-tracking redirect (Horses.com).
 *
 * Looks up the vendor in apps/horses-com/src/data/affiliate-routes.ts, fills
