...
export const metadata: Metadata = buildMetadata({
  siteId: 'seniorpets',
  title: 'Privacy Policy | SeniorPetPharmacy',
  description: 'SeniorPetPharmacy privacy policy — how we collect, use, and protect your data.',
  ...
  return (
    <div className="px-container sm:px-container-sm py-16 max-w-content mx-auto">
      ...
      <div className="carloOS-article">
        <h2>Who We Are</h2>
        <p>SeniorPetPharmacy is owned and operated by Bolton Properties, LLC. This privacy policy applies to seniorpetpharmacy.com and covers how we collect, use, and protect information from visitors to our site.</p>
        ...
        <p>SeniorPetPharmacy participates in affiliate programs including Amazon Associates, Chewy, Trupanion, Healthy Paws, and others. When you click a link labeled with our affiliate disclosure and make a purchase, we earn a commission at no additional cost to you. Affiliate links do not affect our editorial rankings — see our <Link href="/editorial-standards">Editorial Standards</Link> for our independence policy and our <Link href="/legal/affiliate-disclosure">Affiliate Disclosure</Link> for the FTC-required statement.</p>
        ...
        <h2>Your Rights</h2>
        <p>You may request access to, correction of, or deletion of your personal data by contacting us at privacy@seniorpetpharmacy.com. California residents have additional rights under CCPA, including the right to know what personal information is collected, the right to delete personal information, and the right to opt out of the sale of personal information (we do not sell personal information).</p>

        <h2>Children&apos;s Privacy</h2>
        <p>SeniorPetPharmacy is not directed at children under 13. We do not knowingly collect personal information from children under 13. If you believe we have collected such information, contact us and we will delete it.</p>
        ...
        <h2>Contact</h2>
        <p>Privacy questions: privacy@seniorpetpharmacy.com</p>
      </div>
