/**
 * /go/[vendor]/[sku] — affiliate click-tracking redirect (Saddle.com).
 *
 * Looks up the vendor in apps/saddle-com/src/data/affiliate-routes.ts, fills
