  ...
  return (
    <>
      ...
      <ArticleLayout siteId="saddle-com"
        hero={{ title: 'Horse Trailer Loading Guide', subtitle: 'A horse that loads willingly is safer for itself, its handler, and bystanders than one that must be wrestled into a trailer. Forcing a horse that is afraid creates a horse that is more afraid. Building loading through positive association and pressure-release takes longer the first time but produces a horse that loads reliably for life.', category: 'Horse Care Guide', authorName: 'Victoria Marsh, CSF', authorCredentials: 'Certified Equine Professional', authorAvatar: '🐴', publishedAt: 'May 2025', readTime: '9 min' }}
