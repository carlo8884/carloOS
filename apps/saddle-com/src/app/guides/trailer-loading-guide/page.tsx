...
export const metadata: Metadata = buildMetadata({ siteId: 'saddle-com', title: 'Horse Trailer Loading Guide — Positive Training | Saddle.com', description: 'Teaching a horse to load willingly and safely.', path: '/guides/trailer-loading-guide', type: 'article' })
