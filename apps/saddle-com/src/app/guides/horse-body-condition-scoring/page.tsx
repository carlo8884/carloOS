...
export const metadata: Metadata = buildMetadata({ siteId: 'saddle-com', title: 'Horse Body Condition Scoring — Henneke Scale Explained | Saddle.com', description: 'The Henneke 1-9 Body Condition Score assesses fat deposits in 6 locations.', path: '/guides/horse-body-condition-scoring', type: 'article' })
