...
export const metadata: Metadata = buildMetadata({ siteId: 'saddle-com', title: 'English Riding Guide — Disciplines, Equipment | Saddle.com', description: 'Introduction to English riding.', path: '/guides/english-riding-guide', type: 'article' })
