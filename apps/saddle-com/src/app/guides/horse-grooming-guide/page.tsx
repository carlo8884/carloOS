  ...
  return (
    <>
      ...
      <ArticleLayout siteId="saddle-com"
        ...
        breadcrumbs={[{ name: 'Home', href: '/' }, { name: 'Guides', href: '/guides' }, { name: 'Horse Grooming', href: '/guides/horse-grooming-guide' }]}
        relatedLinks={[
      ...
      >
        <div className="carloOS-article">
          ...
          <ReviewCard
            ...
            ctaHref="/go/smartpak/hoof-pick-brush?s=guides-horse-grooming-guide"
          ...
          <ReviewCard
            ...
            ctaHref="/go/smartpak/grooming-kit-bundle?s=guides-horse-grooming-guide"
            ctaAffiliateProgram="smartpak"
