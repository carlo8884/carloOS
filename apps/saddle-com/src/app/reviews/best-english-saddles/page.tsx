        ...
        <div className="grid lg:grid-cols-[1fr_270px] gap-14">
          <div>
            ...
            <ReviewCard id="roxane" badge="Best Dressage" badgeEmoji="🏆" name="Stubben Roxane" subtitle="Deep seat · Quick-Change tree (5 widths) · Hand-finished German leather" score={9.5} winner
              description={<p>The Roxane is widely treated as a benchmark dressage saddle — Quick-Change tree width adjustment, 130 years of German craftsmanship, and a deep seat geometry developed alongside FEI-level dressage riders. Panel construction is supple and fits a wider range of horses than many competitors. Resale value is excellent. See the <Link href="/reviews/stubben-saddle-review" className="text-brand-primary">full Stubben review →</Link></p>}
              ...
              pros={['Quick-Change tree', 'Hand-finished German bridle leather', 'Strong resale value']} cons={['$3,200–4,500 new — premium investment']}
              price="$3,200–$4,500" ctaText="Find a Stubben Dealer →" ctaHref="/go/amazon-brand/stubben+roxane+dressage+saddle?s=reviews-best-english-saddles" ctaAffiliateProgram="amazon" ctaAffiliateProduct="stubben-roxane" />
            <ReviewCard id="gen-x" badge="Best Show Jumping" badgeEmoji="⭐" name="Pessoa Gen X Pro" subtitle="Close contact · Forward flap · Top-level showjumping geometry · Minimal bulk" score={9.2}
              ...
              price="$2,400–$3,200" ctaText="Find a Pessoa Dealer →" ctaHref="/go/amazon-brand/pessoa+gen+x+pro+jumping+saddle?s=reviews-best-english-saddles" ctaAffiliateProgram="amazon" ctaAffiliateProduct="pessoa-gen-x-pro" />
            <ReviewCard id="bates" badge="Best All-Purpose" badgeEmoji="🐴" name="Bates Caprilli All-Purpose" subtitle="CAIR panel system · Adjustable gullet · Eventing and AP riding" score={9.0}
              ...
              price="$800–$2,000" ctaText="Find a Bates Dealer →" ctaHref="/go/amazon-brand/bates+caprilli+all+purpose+saddle?s=reviews-best-english-saddles" ctaAffiliateProgram="amazon" ctaAffiliateProduct="bates-caprilli" />
            <ReviewCard id="collegiate" badge="Best Budget" badgeEmoji="💰" name="Collegiate Convertible AP" subtitle="Adjustable gullet · Under $800 · Best budget English option" score={8.4}
              ...
              specs={[{ label: 'Gullet', value: 'Adjustable (5 widths)', highlight: 'good' }, { label: 'Price', value: 'Lowest in this lineup', highlight: 'good' }, { label: 'Vs Used Premium', value: 'Check used market first', highlight: 'warn' }]}
              ...
              price="$400–$800" ctaText="Find a Collegiate Dealer →" ctaHref="/go/amazon-brand/collegiate+convertible+all+purpose+saddle?s=reviews-best-english-saddles" ctaAffiliateProgram="amazon" ctaAffiliateProduct="collegiate-convertible-ap" />
            ...
            <div id="stubben-brand" className="bg-brand-surface border border-brand-border rounded-xl p-6 mb-5">
              ...
              <p className="text-sm text-brand-text-mid leading-relaxed mb-0"><strong>Watch out for:</strong> Stubbens are heavy by modern standards; weight matters for jumper riders and smaller adults. The leather requires a longer break-in period than CAIR-paneled saddles. Used market is deep — a 10-year-old Stubben in good condition is often among the best-value premium English saddles on the used market.</p>
            </div>
