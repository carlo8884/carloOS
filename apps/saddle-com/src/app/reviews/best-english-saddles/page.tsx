        ...
        <div className="grid lg:grid-cols-[1fr_270px] gap-14">
          <div>
            ...
            <ReviewCard id="roxane" badge="Best Dressage" badgeEmoji="🏆" name="Stubben Roxane" subtitle="Deep seat · Quick-Change tree (5 widths) · Hand-finished German leather" score={9.5} winner
              ...
              price="$3,200–$4,500" ctaText="Find a Stubben Dealer →" ctaHref="/go/amazon-brand/stubben+saddle?s=reviews-best-english-saddles" ctaAffiliateProgram="sharesale" ctaAffiliateProduct="stubben-roxane" />
            <ReviewCard id="gen-x" badge="Best Show Jumping" badgeEmoji="⭐" name="Pessoa Gen X Pro" subtitle="Close contact · Forward flap · Top-level showjumping geometry · Minimal bulk" score={9.2}
              ...
              price="$2,400–$3,200" ctaText="Find a Pessoa Dealer →" ctaHref="/go/amazon-brand/pessoa+saddle?s=reviews-best-english-saddles" ctaAffiliateProgram="sharesale" ctaAffiliateProduct="pessoa-gen-x-pro" />
            <ReviewCard id="bates" badge="Best All-Purpose" badgeEmoji="🐴" name="Bates Caprilli All-Purpose" subtitle="CAIR panel system · Adjustable gullet · Eventing and AP riding" score={9.0}
              ...
              price="$800–$2,000" ctaText="Find a Bates Dealer →" ctaHref="/go/amazon-brand/bates+saddle?s=reviews-best-english-saddles" ctaAffiliateProgram="sharesale" ctaAffiliateProduct="bates-caprilli" />
            <ReviewCard id="collegiate" badge="Best Budget" badgeEmoji="💰" name="Collegiate Convertible AP" subtitle="Adjustable gullet · Under $800 · Best budget English option" score={8.4}
              ...
              price="$400–$800" ctaText="Find a Collegiate Dealer →" ctaHref="/go/amazon-brand/collegiate+saddle?s=reviews-best-english-saddles" ctaAffiliateProgram="sharesale" ctaAffiliateProduct="collegiate-convertible-ap" />
