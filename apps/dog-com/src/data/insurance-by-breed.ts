/**
 * Dog.com — Breed-specific pet insurance routing data.
 *
...
export interface BreedInsuranceProfile {
  ...
  slug: string
  /** Slug in apps/dog-com/src/data/breeds.ts — used for cross-linking to
   *  /breeds/[slug] and /dna-testing/breeds/[breed]. May differ from the
   *  insurance slug when breeds.ts uses a shorter form. */
