...
export default function PuppySchedulePage() {
  return (
    <>
      ...
      relatedLinks={[{ title: 'New Puppy Checklist', href: '/tools/new-puppy-checklist', category: 'Tools' }, { title: 'Pregnancy & Whelping Calendar', href: '/tools/dog-gestation-calculator', category: 'Tools' }, { title: 'Dog Training Hub', href: '/training', category: 'Hub' }, { title: 'Crate Training', href: '/training/crate-training', category: 'Training' }, { title: 'House Training', href: '/training/house-training', category: 'Training' }, { title: 'Puppy Nutrition', href: '/nutrition/puppy-nutrition', category: 'Nutrition' }]}
      schema={schema}
      sidebar={<>
