    ...
    <ArticleLayout siteId="dog-com"
      ...
      sidebar={<>
        ...
        <div className="bg-brand-dark rounded-lg p-5 mb-4">
              <div className="text-xs uppercase tracking-wide text-brand-primary mb-1 font-bold">Border Collie + Insurance</div>
              <h3 className="font-display text-base font-bold text-brand-white mb-2">Breed-specific premium &amp; coverage</h3>
              <p className="text-xs text-white/60 mb-3 leading-relaxed">Border Collies have a specific hereditary condition profile that should drive your carrier choice. Premiums vary materially by breed.</p>
              <a href="/pet-insurance/breeds/border-collie" className="inline-block text-xs font-bold text-brand-primary hover:underline">See Border Collie insurance picks →</a>
            </div>
