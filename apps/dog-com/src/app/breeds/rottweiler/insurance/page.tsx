/**
 * Dog.com — Rottweiler pet-insurance spoke (static breed-folder route).
 *
...
export const metadata: Metadata = buildMetadata({
  siteId: 'dog-com',
  title: "Rottweiler Pet Insurance: Is It Worth It? | Dog.com",
  description: "Is pet insurance worth it for a Rottweiler? The breed's top hereditary cost drivers, why enrolling early matters, and what to check on a quote.",
  path: '/breeds/rottweiler/insurance',
  type: 'article',
})

export default function RottweilerInsurancePage() {
  return <BreedInsuranceContent slug="rottweiler" />
}
