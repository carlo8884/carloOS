/**
 * Dog.com — Bulldog pet-insurance spoke (static breed-folder route).
 *
...
export const metadata: Metadata = buildMetadata({
  siteId: 'dog-com',
  title: "Bulldog Pet Insurance: Is It Worth It? | Dog.com",
  description: "Is pet insurance worth it for a Bulldog? The breed's top hereditary cost drivers, why enrolling early matters, and what to check on a quote.",
  path: '/breeds/bulldog/insurance',
  type: 'article',
})

export default function BulldogInsurancePage() {
  return <BreedInsuranceContent slug="bulldog" />
}
