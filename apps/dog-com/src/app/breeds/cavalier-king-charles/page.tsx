      ...
      <div className="carloOS-article">
        ...
        <div className="mb-8">
          <p className="mb-1 text-2xs font-bold uppercase tracking-eyebrow text-brand-primary">
            Keep the cavalier-king-charles checklist
          </p>
          <h2 className="mb-2 font-display text-xl font-bold text-brand-dark">
            Cavalier King Charles checklist
          </h2>
          <p className="mb-3 text-sm leading-relaxed text-brand-text-mid">
            Email the laminated-dog-cavalier-50pct-mvd-chart,
            dog-fridge-cavalier-phantom-scratch-card, and
            canine-first-owner-cavalier-king-charles-handbook
            notes that match the 50%-murmur-by-age-5 MVD
            floor, the phantom-scratch CM/SM watch, and
            first-time-owner notes on this page — a laminated
            dog Cavalier 50% MVD chart so the age-5 murmur /
            age-10 near-100% notes are posted on the fridge
            (not a Yorkie 42-tooth jaw chart, not a Chaser
            1,000-object chart), a fridge Cavalier phantom-
            scratch card so the CM/SM / 70% MRI notes are
            labeled in the kitchen (not a 4-to-6-hour feed
            card, not a finger-toothbrush hop), and a first-
            owner Cavalier King Charles handbook so the
            YES-typically / MVD-protocol / phantom-scratch
            grounding is a physical kitchen book (not a
            first-owner Yorkshire Terrier handbook).
          ...
          <EmailCapture
            variant="inline"
            siteId="dog-com"
            title="Cavalier King Charles checklist"
            subtitle="Email the 50% MVD chart, phantom-scratch card, and first-owner handbook notes. No spam."
            ctaText="Email my cavalier-king-charles checklist"
            source="breed-cavalier-king-charles-under-hero"
          />
        </div>

        <p>The companion story starts in 1920s England: Roswell Eldridge asked breeders to recreate the longer-muzzled toy spaniels in 17th-century paintings. That royal-lap / small-skull history is why a household Cavalier still needs annual murmur screening from age 1 and a phantom-scratch watch, not a crate-only afternoon. Cavalier King Charles Spaniels are typically first-time-owner friendly — YES-typically — when the household accepts the MVD 50%-by-age-5 murmur floor, the CM/SM phantom-scratch watch, and cardiologist-grade breeding questions.</p>
        ...
        <div className="my-6 p-5 border border-brand-border rounded-xl bg-brand-surface not-prose">
          <div className="text-2xs font-bold uppercase tracking-eyebrow text-brand-primary mb-3">
            Shop the Cavalier King Charles home kit
          </div>
          <p className="text-sm text-brand-text-mid mb-4 leading-relaxed">
            These Amazon category searches match the on-page
            50%-murmur-by-age-5 MVD floor, the phantom-
            scratch CM/SM watch, and first-time-owner notes
            — a laminated dog Cavalier 50% MVD chart, a
            fridge Cavalier phantom-scratch card, and a
            first-owner Cavalier King Charles handbook.
          ...
          <div className="flex flex-col gap-3 mt-3">
            <ShopCtas
              amazonHref="/go/amazon-brand/laminated+dog+cavalier+50pct+mvd+chart?s=breed-cavalier"
              amazonLabel="Browse laminated dog Cavalier 50% MVD charts on Amazon →"
            />
            <ShopCtas
              amazonHref="/go/amazon-brand/dog+fridge+cavalier+phantom+scratch+card?s=breed-cavalier"
              amazonLabel="Browse fridge Cavalier phantom-scratch cards on Amazon →"
            />
            <ShopCtas
              amazonHref="/go/amazon-brand/canine+first+owner+cavalier+king+charles+handbook?s=breed-cavalier"
              amazonLabel="Browse first-owner Cavalier King Charles handbooks on Amazon →"
            />
          </div>
        </div>
