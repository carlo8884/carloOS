/**
 * Dog.com — Great Dane pet-insurance spoke (static breed-folder route).
 *
...
export const metadata: Metadata = buildMetadata({
  siteId: 'dog-com',
  title: "Great Dane Pet Insurance: Is It Worth It? | Dog.com",
  description: "Is pet insurance worth it for a Great Dane? The breed's top hereditary cost drivers, why enrolling early matters, and what to check on a quote.",
  path: '/breeds/great-dane/insurance',
  type: 'article',
})

export default function GreatDaneInsurancePage() {
  return <BreedInsuranceContent slug="great-dane" />
}
