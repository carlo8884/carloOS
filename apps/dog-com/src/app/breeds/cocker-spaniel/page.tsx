  ...
  return (
    <ArticleLayout siteId="dog-com"
      ...
      sidebar={<>
        ...
        <EmailCapture variant="sidebar" siteId="dog-com" title="Free Dog Health Tips" subtitle="DVM-written guidance weekly." source="breed-cocker" />
      </>}
    >
