...
export const metadata: Metadata = buildMetadata({
  siteId: 'dog-com',
  title: 'Best Pet DNA Tests 2026 — Embark, Wisdom Panel, Basepaws | Dog.com',
  description:
    'Independent comparison of the 3 leading pet DNA tests: marker counts, breed library, health screening, pricing, and which fits your situation.',
  path: '/dna-testing',
  type: 'article',
})
          ...
          {ranked.map((t) => (
            ...
            >
              ...
              <AffiliateLink
                vendor={t.vendor}
                sku="home"
                source={`dna-testing-hub-${t.slug}`}
                className="inline-block bg-brand-primary text-white px-4 py-2 rounded-lg font-semibold text-sm text-center no-underline hover:opacity-90 mb-2"
              >
                Shop {t.brand} →
              </AffiliateLink>
              <Link
        ...
        <div className="bg-brand-primary-pale border-l-4 border-brand-primary rounded-r-xl p-6 mb-12">
          ...
          <div className="flex flex-wrap gap-3">
            <AffiliateLink
              vendor="embarkvet"
              sku="home"
              source="dna-testing-hub-bottom-embark"
              className="inline-block bg-brand-primary text-white px-5 py-2 rounded-lg font-semibold no-underline hover:opacity-90"
            >
              Order Embark (dogs)
            </AffiliateLink>
            <AffiliateLink
              vendor="wisdompanel"
              sku="home"
              source="dna-testing-hub-bottom-wisdom"
              className="inline-block bg-brand-primary text-white px-5 py-2 rounded-lg font-semibold no-underline hover:opacity-90"
            >
            ...
            <AffiliateLink
              vendor="basepaws"
              sku="home"
              source="dna-testing-hub-bottom-basepaws"
              className="inline-block bg-brand-primary text-white px-5 py-2 rounded-lg font-semibold no-underline hover:opacity-90"
            >
              Order Basepaws (cats)
            </AffiliateLink>
