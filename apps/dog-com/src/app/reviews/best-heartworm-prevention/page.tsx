...
const PICKS = [
  { label: 'Best Standalone HW', emoji: '🏆', name: 'Heartgard Plus', subtitle: 'Ivermectin + pyrantel · Commonly used', href: '#heartgard' },
      ...
      <div className="px-container-sm sm:px-container py-14">
        <div className="grid lg:grid-cols-[1fr_270px] gap-14">
          <div>
            ...
            <ScoreMethodology />
            <ReviewCard id="heartgard" badge="Best Standalone" badgeEmoji="🏆" name="Heartgard Plus" subtitle="Ivermectin + pyrantel pamoate · Monthly beef chew · Commonly used HW preventive" score={9.3} winner
