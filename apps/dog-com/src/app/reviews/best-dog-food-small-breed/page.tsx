      ...
      <div className="px-container-sm sm:px-container py-14">
        <div className="grid lg:grid-cols-[1fr_270px] gap-14">
          <div>
            ...
            />
            <ReviewCard id="purina" badge="Best High-Protein" badgeEmoji="⭐" name="Purina Pro Plan Small & Toy Breed Adult" subtitle="30% protein · Live probiotics · Commonly veterinarian-recommended brand" score={9.2}
