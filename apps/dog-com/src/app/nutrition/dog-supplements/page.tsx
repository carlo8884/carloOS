...
const SUPPLEMENTS = [
  ...
  { name: 'Glucosamine & Chondroitin', evidence: 'moderate' as const, dose: 'Glucosamine 22mg/kg daily; Chondroitin 15mg/kg daily', brands: 'Cosequin DS, Dasuquin, Nutramax products (NASC seal)', summary: 'The most commonly recommended joint supplement in veterinary practice. Evidence is moderate — some studies show meaningful reduction in arthritis signs; others show minimal effect vs placebo. The clinical reality: many dogs seem to respond, and the safety profile is excellent. Worth trying for dogs with diagnosed arthritis or joint disease. Look for the NASC (National Animal Supplement Council) quality seal. Give for 4–6 weeks before evaluating effect — onset is gradual. Dasuquin (with avocado/soybean unsaponifiables) has slightly better evidence than basic glucosamine-only products.' },
