    ...
    <>
      ...
      >
        <div className="carloOS-article">
          ...
          <p>The zoonotic risk is particularly significant for: immunocompromised people (chemotherapy patients, HIV/AIDS patients, transplant recipients), elderly household members, young children (who may have contact with the dog's mouth and feces), and pregnant women. For households with any of these individuals, the <a href="https://www.cdc.gov/healthy-pets/about/raw-pet-food-and-bacteria.html" rel="noopener" target="_blank" className="text-brand-primary hover:underline">CDC</a> and <a href="https://avma.org" rel="noopener" target="_blank" className="text-brand-primary hover:underline">AVMA</a> advise against feeding raw meat to pets for this reason.</p>
