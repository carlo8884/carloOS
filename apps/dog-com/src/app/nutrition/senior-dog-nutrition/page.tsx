...
export const metadata: Metadata = buildMetadata({ siteId: 'dog-com', title: 'Senior Dog Nutrition — When to Switch | Dog.com', description: 'Senior dog nutrition guide.', path: '/nutrition/senior-dog-nutrition', type: 'article' })
