...
const med = buildMedicalWebPageSchema({ name: 'Pyoderma in Dogs', description: 'Bacterial skin infections — types, antibiotic treatment, and root cause identification.', url: 'https://dog.com/health/dog-pyoderma', authorName: 'Dr. Amanda Reyes, DVM, DACVIM', lastReviewed: '2025-05-01' })
    ...
    <>
      ...
      >
        <div className="carloOS-article">
          ...
          <p>First-line antibiotics for uncomplicated superficial pyoderma: Cephalexin (22 mg/kg BID, 3–6 weeks), Cefpodoxime (Simplicef — once daily, 3–6 weeks), and Amoxicillin-clavulanate (Clavamox). Culture and sensitivity is essential before starting antibiotics in: deep pyoderma, recurring pyoderma that has been treated multiple times, pyoderma that is not responding to first-line antibiotics, or any situation where methicillin-resistant Staphylococcus pseudintermedius (MRSP) is a concern (dogs with prior antibiotic exposure, veterinary worker households).</p>
