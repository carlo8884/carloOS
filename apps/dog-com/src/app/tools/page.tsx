...
const TOOLS = [
  {
    ...
    desc: 'Check the signs you are seeing against veterinary emergency-medicine criteria and get a conservative urgency read -- go now, same-day vet, or monitor closely. A triage aid, not a diagnosis.',
    tag: 'Health',
  },
  {
    href: '/tools/dog-grimace-scale',
    title: 'Dog Grimace Scale',
    desc: 'Is your dog in pain? Score five facial signs — ears, eyes, muzzle, brow, head — on this owner pain-face checklist. Planning / observation reference, not a diagnosis. High-pain faces go to emergency triage first, not a shopping list.',
    tag: 'Health',
  },
  {
  ...
  },
  {
    ...
    desc: 'Is your dog under or overweight? Answer three hands-on checks — rib feel, waist from above, belly tuck from the side — to estimate your dog\'s body condition score on the 1–9 scale. Educational only: every result defers a target weight to your veterinarian.',
    tag: 'Health',
  },
  {
    ...
    <>
      ...
      <section className="bg-brand-surface px-container-sm sm:px-container pb-section">
        <div className="max-w-2xl">
          ...
          <p className="mb-4 text-base leading-relaxed text-brand-text-mid">For the reference content that explains what these numbers mean, start with{' '}
            <Link
            ...
            covers the broader diet context: food label reading, WSAVA guidelines, and condition-specific diets</p>
        </div>
      </section>
      ...
      <section className="bg-brand-surface px-container-sm sm:px-container pb-section">
        ...
        <div className="my-6 p-5 border border-brand-border rounded-xl bg-brand-surface not-prose max-w-content-wide">
          ...
          <div className="flex flex-col gap-3">
            <ShopCtas
              amazonHref="/go/amazon-brand/dog+supplies?s=tools-hub"
