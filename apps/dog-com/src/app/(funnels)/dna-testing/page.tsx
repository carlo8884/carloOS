...
export const metadata: Metadata = buildMetadata({
  siteId: 'dog-com',
  title: 'Best Pet DNA Tests 2026 — Embark vs Wisdom vs Basepaws | Dog.com',
  description:
    'Independent comparison of the 3 leading pet DNA tests. Markers, breed library, health screening, and pricing.',
  path: '/dna-testing',
  type: 'article',
})
