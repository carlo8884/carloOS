...
export const CARRIERS: CarrierProfile[] = [
  ...
  },
  {
    ...
    editorialScore: 9.0,
    editorialNote: 'Among the most comprehensive coverage; weak point is the premium.',
    states: 'all-50',
    hasApp: true,
    hasTelehealthIncluded: false,
  },
  {
    ...
    editorialScore: 8.8,
    editorialNote: 'One of the more accommodating pre-existing condition stances.',
    states: 'most',
    hasApp: true,
    hasTelehealthIncluded: false,
  },
  ...
  },
  {
    ...
    editorialScore: 8.6,
    editorialNote: 'A balanced mix of coverage breadth and wellness add-on.',
    states: 'all-50',
    hasApp: true,
    hasTelehealthIncluded: false,
  },
