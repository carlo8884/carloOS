...
const breadcrumbSchema = buildBreadcrumbSchema({
  items: [
    ...
    { name: 'Affiliate Disclosure', url: 'https://vets.co/legal/affiliate-disclosure' },
  ],
})
  ...
  return (
    <>
      ...
      <div className="carloOS-article">
        ...
        <p>Vets.co participates in affiliate programs including Trupanion, Healthy Paws, Embrace, Chewy, and telehealth services including Vetster. When you click a product link on this site and make a qualifying purchase, we may earn a commission at no additional cost to you. This relationship is disclosed in compliance with the U.S. Federal Trade Commission&apos;s 16 CFR Part 255 guidance on endorsements and testimonials.</p>

        <h2>How It Works</h2>
        <ul>
          <li>Some product links on Vets.co are affiliate links. You can identify them by the disclosure label on or near the link (typically &quot;Affiliate link&quot;, an affiliate-link icon, or a section-level disclosure at the top of the page).</li>
        ...
        <p>Vets.co is a participant in the following affiliate programs: Trupanion, Healthy Paws, Embrace, Chewy, and telehealth services including Vetster. We may add or remove programs over time and will update this page accordingly. Adding a new affiliate program never retroactively changes existing rankings.</p>

        <h2>Questions</h2>
        <p>If you spot a missing disclosure, an outdated affiliate link, or anything that looks like editorial bias toward a specific product or brand, please email legal@vets.co.</p>
      </div>
