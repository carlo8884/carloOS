    ...
    <>
      ...
      <ArticleLayout siteId="vets-co"
        ...
        sidebar={<>
          ...
          <RelatedLinks title="Related Guides" links={[{ label: 'Dehydration Signs', href: '/health/dehydration-in-dogs' }, { label: 'Pain Signs in Dogs', href: '/health/pain-signs-dogs' }, { label: 'Best Pet Insurance', href: '/reviews/best-pet-insurance' }]} />
