    ...
    <>
      ...
      <ArticleLayout siteId="vets-co"
        ...
        sidebar={<>
          ...
          <RelatedLinks title="Related Guides" links={[{ label: 'Senior Pet Care', href: '/health/senior-pet-care' }, { label: 'Senior Bloodwork Guide', href: '/health/senior-bloodwork-guide' }, { label: 'Dehydration in Dogs', href: '/health/dehydration-in-dogs' }]} />
      ...
      >
        <div className="carloOS-article">
          ...
          <h2>What CKD Is</h2>
          <p>The kidneys filter waste, balance fluids and electrolytes, regulate blood pressure, and support red blood cell production. In chronic kidney disease, functional kidney tissue (nephrons) is gradually lost and replaced by scar tissue. The decline is irreversible and tends to progress over months to years. Because cats compensate well, they often show no signs until a large fraction of kidney function is already gone — which is why screening older cats is so valuable.</p>
