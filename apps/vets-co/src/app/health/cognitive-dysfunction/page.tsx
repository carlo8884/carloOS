    ...
    <>
      ...
      >
        <div className="carloOS-article">
          ...
          <p><strong>Anipryl (selegiline):</strong> <a href="https://www.fda.gov/animal-veterinary" rel="noopener" target="_blank" className="text-brand-primary hover:underline">FDA</a>-approved for canine CDS. A monoamine oxidase B inhibitor that increases dopamine availability in the brain and may reduce oxidative damage. Oral tablet once daily in the morning. Approximately 70% of dogs show some improvement in CDS signs within 30 days of starting. Not all dogs respond. Side effects are uncommon but include GI upset and restlessness. Has drug interactions — disclose all current medications before starting.</p>
