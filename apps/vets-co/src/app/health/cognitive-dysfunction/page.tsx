    ...
    <>
      ...
      >
        <div className="carloOS-article">
          ...
          <p>Household physical supports can sit alongside that enrichment after a veterinarian has ruled out a medical mimic. A plug-in night light keeps a familiar hallway visible when the dog wanders after dark. A sniff box with new objects gives a short, low-arousal scent session. A senior food-puzzle toy stretches a few kibble pieces into a brief enrichment task. These are household tools, not treatments. They do not replace a veterinary CDS plan, they are not Purina Pro Plan Bright Mind, and they are not Anipryl (selegiline), melatonin, or fish-oil supplements. Ask your veterinarian which of these, if any, belong in this dog&rsquo;s kit.</p>
          ...
          <div className="my-6 p-5 border border-brand-border rounded-xl bg-brand-surface not-prose">
            ...
            <div className="flex flex-col gap-3">
              <ShopCtas
                ...
                amazonLabel="Browse plug-in night lights on Amazon →"
              />
              <ShopCtas
                amazonHref="/go/amazon-brand/dog+sniff+box?s=health-cognitive-dysfunction"
                amazonLabel="Browse dog sniff boxes on Amazon →"
              />
              <ShopCtas
