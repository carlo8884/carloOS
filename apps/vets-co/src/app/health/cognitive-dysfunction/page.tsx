...
export const metadata: Metadata = buildMetadata({ siteId: 'vets-co', title: 'Cognitive Dysfunction Syndrome in Dogs — Dog Dementia Signs | Vets.co', description: 'CDS (dog dementia) affects 22% of dogs 9-11 years. Disorientation, sleep disruption, house soiling, and anxiety.', path: '/health/cognitive-dysfunction', type: 'article' })
    ...
    <>
      ...
      >
        <div className="carloOS-article">
          ...
          <p><strong>Anipryl (selegiline):</strong> FDA-approved for canine CDS. A monoamine oxidase B inhibitor that increases dopamine availability in the brain and may reduce oxidative damage. Oral tablet once daily in the morning. Approximately 70% of dogs show some improvement in CDS signs within 30 days of starting. Not all dogs respond. Side effects are uncommon but include GI upset and restlessness. Has drug interactions — disclose all current medications before starting.</p>
          ...
          <p><strong>Melatonin:</strong> For dogs with disrupted sleep-wake cycles — 1–3mg 30 minutes before the desired sleep time. Can restore more normal nocturnal sleep and reduce nighttime restlessness. Safe for most dogs, but verify appropriate dose with your veterinarian.</p>
