        ...
        <>
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { label: 'Talk to a vet (non-ER)', href: '/telehealth' },
        ...
        <div id="insurance-home-care-kit" className="mt-8 mb-8">
          ...
          <div className="mt-4 rounded-xl border border-brand-border bg-brand-surface p-5">
            ...
            <div className="flex flex-col gap-3">
              ...
              />
              <ShopCtas
                amazonHref="/go/amazon-brand/digital+pet+thermometer?s=tools-insurance-reimbursement-estimator"
                amazonLabel="Browse digital pet thermometers on Amazon →"
              />
              <ShopCtas
                amazonHref="/go/amazon-brand/digital+pet+scale?s=tools-insurance-reimbursement-estimator"
                amazonLabel="Browse digital pet scales on Amazon →"
              />
              <ShopCtas
                amazonHref="/go/amazon-brand/pet+recovery+cone?s=tools-insurance-reimbursement-estimator"
