  ...
  return (
    <div className="px-container-sm sm:px-container py-16 max-w-content mx-auto">
      ...
      <div className="carloOS-article">
        ...
        <ul>
          <li><strong>Sources are cited where it matters.</strong> Breed-health content draws on <a href="https://www.morrisanimalfoundation.org/" rel="noopener" target="_blank" className="text-brand-primary hover:underline">Morris Animal Foundation</a> cohort data, breed-club health surveys, and the AVMA / ACVIM / AAHA literature. Insurance content draws on published policy documents and aggregated payout data.</li>
