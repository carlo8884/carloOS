  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-container-sm sm:px-container">
      <div className="text-center max-w-lg">
        ...
        <Link href="/reviews/best-pet-insurance" className="inline-flex items-center font-bold text-sm px-6 py-3 rounded no-underline text-white transition-colors" style={{ background: 'var(--brand-primary)' }}>Compare pet insurance →</Link>
      </div>
    </div>
  )
}
