        ...
        <div className="carloOS-article">
          ...
          <div className="my-6 rounded-lg border border-brand-primary/30 bg-brand-primary-pale p-5">
            ...
            <p className="text-sm text-brand-text-mid leading-relaxed mb-4 mt-0">
              Pre-existing condition handling varies meaningfully between carriers — particularly how each defines &ldquo;curable&rdquo; and sets the symptom-free window. Our editorial comparison notes these differences across the 11 major insurers so you can find the one that fits your pet&apos;s history.
            </p>
