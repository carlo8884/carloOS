...
const schema = buildArticleSchema({ siteId: 'vets-co', title: 'Labrador Retriever Health — Veterinary Perspective', description: 'Managing Labrador health from a practicing DVM.', url: 'https://vets.co/breeds/labrador-health', imageUrl: '', authorName: 'Dr. Sarah Webb, DVM', publishedAt: '2025-05-01T00:00:00Z', modifiedAt: '2025-05-01T00:00:00Z' })
...
export default function VetsLabradorHealthPage() {
  return (
    <>
      ...
      <ArticleLayout
      siteId="vets-co"
      hero={{ title: 'Labrador Retriever Health — A Veterinarian\'s Perspective', subtitle: 'Labradors are among my highest-volume patients. Fantastic temperaments, but specific health predispositions require proactive management. Here\'s what I prioritize with every Lab owner.', category: 'Breed Health Guide', authorName: 'Dr. Sarah Webb, DVM', authorCredentials: 'General Practice · 14 years', authorAvatar: '👩‍⚕️', publishedAt: 'May 2025', readTime: '9 min', dvmReviewed: true }}
      ...
      sidebar={<>
        ...
        <EmailCapture variant="sidebar" siteId="vets-co" title="Free Pet Health Tips" subtitle="DVM-written guidance every Tuesday." source="breeds-labrador" />
      </>}
    >
      <div className="carloOS-article">
        ...
        <p>I can reliably improve quality and length of life in nearly every Labrador I see by addressing weight. The POMC mutation in this breed is real and documented in peer-reviewed research — Labs with the mutation are significantly more food-motivated and prone to obesity. If your Lab constantly acts hungry, that is likely not manipulation; it is a genuine difference in hunger signaling.</p>
