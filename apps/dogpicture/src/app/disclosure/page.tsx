...
export const metadata: Metadata = buildMetadata({
  siteId: 'dogpicture',
  title: 'Affiliate Disclosure — DogPicture.com',
  description: 'Editorial integrity policy and FTC affiliate disclosure for DogPicture.com.',
  path: '/disclosure',
  type: 'article',
})
  ...
  return (
    <main className="min-h-screen bg-brand-white py-16">
      <div className="max-w-content mx-auto px-container">
        ...
        <AffiliateDisclosure variant="page" siteId="dogpicture" />
      </div>
    </main>
  )
}
