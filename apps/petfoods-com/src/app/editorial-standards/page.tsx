...
export const metadata: Metadata = buildMetadata({
  siteId: 'petfoods-com',
  title: 'Editorial Standards | PetFoods.com',
  description: 'PetFoods.com editorial standards — how we research, source, and review our content.',
...
export default function EditorialStandardsPage() {
  ...
  return (
    <div className="px-container-sm sm:px-container py-16 max-w-content mx-auto">
      ...
      <p>PetFoods.com is a reference publication. The editorial standards below explain how we research, source, fact-check, and disclose interests. They are the same standards that govern every CarloOS-family site.</p>
      ...
      <h2>Authorship</h2>
      <p>Articles are bylined by the PetFoods.com editorial team. Where a specific reviewer or contributor has subject-matter expertise, that credential is named in the byline. We do not impersonate clinical credentials our authors do not hold. “Editorial team” is our default attribution.</p>
      ...
      <p>PetFoods.com does not own equity in any brand it reviews. Affiliate commercial relationships with named vendors are disclosed on every affected page and centrally on <Link href="/disclosure" className="text-brand-primary no-underline hover:underline">/disclosure</Link>.</p>
