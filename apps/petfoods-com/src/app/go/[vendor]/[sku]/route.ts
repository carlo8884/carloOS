/**
 * /go/[vendor]/[sku] — affiliate click-tracking redirect (PetFoods.com).
 *
 * Looks up the vendor in apps/petfoods-com/src/data/affiliate-routes.ts, fills
