...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'How PetFoods.com makes money: Chewy and Amazon retailer affiliates only. No paid brand placements. Editorial-integrity policy.',
  path: '/disclosure',
  type: 'article',
})
...
const schema = buildArticleSchema({
  ...
  title: 'Affiliate Disclosure',
  description:
    'Full FTC-compliant affiliate disclosure for PetFoods.com. Retailer-only affiliates; no brand placements; WSAVA-anchored editorial position.',
  url: 'https://petfoods.com/disclosure',
  imageUrl: '',
  ...
  return (
    <ArticleLayout
      ...
      hero={{
        title: 'Affiliate Disclosure',
        subtitle:
          'How PetFoods.com makes money. Retailer-only affiliate links, no brand placements, and a WSAVA-anchored editorial position that controls how affiliate relationships interact with our brand evaluations.',
        category: 'Legal & Transparency',
        authorName: 'PetFoods.com Editorial — last updated 2026-05-29',
    ...
    >
      <div className="carloOS-article">
        ...
        <p>
          This is the full, unabridged affiliate disclosure for PetFoods.com.
        ...
        <p>
          ...
          If anything here is unclear or appears to contradict a PetFoods.com
          page, email{' '}
          <a href="mailto:editorial@petfoods.com">editorial@petfoods.com</a>.
        </p>
        <p>
        ...
        <p>
          ...
          retailer&apos;s attribution window, the retailer pays PetFoods.com a
          commission. The price you pay is the same as if you had navigated
          to the retailer directly.
        </p>
        <p>
          Every page on PetFoods.com that contains affiliate links carries a
        ...
        <ul>
          <li>
            <strong>Chewy Affiliate Program.</strong> Chewy stocks the vast
            majority of brands we evaluate. Their affiliate program is
        ...
        <p>
          We will add programs to this list as we are accepted. PetFoods.com
          does not currently participate in any brand-direct affiliate
          relationships (manufacturer-operated programs that pay commissions
          for direct-from-brand purchases), because those arrangements would
          create the same conflict-of-interest as a paid placement.
        </p>

        <h2>How We Make Money</h2>
        <ol>
          <li>
            Affiliate commissions from Chewy and Amazon when readers click
        ...
        <p>
          The list below is the load-bearing part of this page. PetFoods.com
          is anchored to the WSAVA (World Small Animal Veterinary
          Association) framework for evaluating pet food manufacturers. That
          framework only stays meaningful if the following limits hold.
        </p>
        <ul>
          <li>
            <strong>We do not accept paid placements from brands.</strong> No
            pet food brand has ever paid PetFoods.com — in money, in product,
            in services, or in any other form of consideration — for
            inclusion in a list, for a more favorable evaluation, or for a
            higher position in any ranking. Brand evaluations are not for
            sale.
          </li>
          <li>
          ...
          <li>
            ...
            Brand rankings are produced first; retailer affiliate links are
            attached afterward.
          </li>
          <li>
        ...
        <p>
          ...
          <a href="mailto:partnerships@petfoods.com">partnerships@petfoods.com</a>.
        </p>
      </div>
    </ArticleLayout>
  )
