  ...
  return (
    ...
    >
      <div className="carloOS-article">
        ...
        <StockImage manifestKey="petfood-com:brand-kirkland-signature" priority aspect="16:9" variant="wide" caption="Kirkland Signature — Costco's store brand evaluated on value, the who-makes-it question, and recall exposure." />
