  ...
  return (
    ...
    >
      <div className="carloOS-article">
        ...
        <StockImage manifestKey="petfood-com:compare-prescription-vs-otc-diets" priority aspect="16:9" variant="wide" caption="Prescription versus over-the-counter diets — what the prescription requirement does and does not mean." />
