...
const FAQ = [
  {
    question: 'Why is fish used in pet food?',
    answer:
      'Fish provides a complete, highly digestible animal protein and is a leading natural source of EPA and DHA, the omega-3 fatty acids with evidence for skin, joint, and other benefits. Named fish also serves as a novel protein for some animals in allergy management. These advantages make fish desirable in both maintenance and therapeutic diets.',
  },
  {
    question: 'Is fish-based pet food safe given mercury concerns?',
    answer:
      'Fish can accumulate mercury and other heavy metals, with larger, longer-lived predatory species accumulating more. The levels in commercial pet food fish ingredients are generally low and regulated, and most diets use smaller forage fish or salmon rather than large predators. For animals eating fish-based diets long-term, sourcing from reputable manufacturers that test for contaminants is the relevant safeguard — this is a minor consideration in well-sourced foods.',
  },
  {
    question: 'Can raw fish cause problems for cats?',
    answer:
      'Some raw fish contain thiaminase, an enzyme that destroys thiamine (vitamin B1), and diets heavy in certain raw fish have caused thiamine deficiency, particularly in cats. Cooking inactivates thiaminase, so cooked commercial fish diets are not a concern, and complete diets are supplemented with thiamine. The risk applies to raw or all-fish home diets, not properly formulated cooked commercial foods.',
  },
  {
    question: 'What is the difference between salmon and salmon meal?',
    answer:
      'Whole fish such as salmon is the wet, unrendered ingredient — mostly water — while fish meal is the rendered, dried, concentrated product. A species-named meal like salmon meal is nutrient- and protein-dense and contributes more finished-product protein per ingoing pound than whole fish. Generic "fish meal" is less transparent than a species-named meal.',
  },
]
  ...
  return (
    ...
    >
      <div className="carloOS-article">
        ...
        <p><strong>Why is fish used in pet food?</strong></p>
        <p>
          Fish provides a complete, highly digestible animal protein and is a leading natural
          source of EPA and DHA, the omega-3 fatty acids with evidence for skin, joint, and other
          benefits. Named fish also serves as a novel protein for some animals in allergy
          management. These advantages make fish desirable in both maintenance and therapeutic
          diets.
        </p>
        <p><strong>Is fish-based pet food safe given mercury concerns?</strong></p>
        <p>
          Fish can accumulate mercury and other heavy metals, with larger, longer-lived predatory
          species accumulating more. The levels in commercial pet food fish ingredients are
          generally low and regulated, and most diets use smaller forage fish or salmon rather
          than large predators. For animals eating fish-based diets long-term, sourcing from
          reputable manufacturers that test for contaminants is the relevant safeguard — this is a
          minor consideration in well-sourced foods.
        </p>
        <p><strong>Can raw fish cause problems for cats?</strong></p>
        <p>
          Some raw fish contain thiaminase, an enzyme that destroys thiamine (vitamin B1), and
          diets heavy in certain raw fish have caused thiamine deficiency, particularly in cats.
          Cooking inactivates thiaminase, so cooked commercial fish diets are not a concern, and
          complete diets are supplemented with thiamine. The risk applies to raw or all-fish home
          diets, not properly formulated cooked commercial foods.
        </p>
        <p><strong>What is the difference between salmon and salmon meal?</strong></p>
        <p>
          Whole fish such as salmon is the wet, unrendered ingredient — mostly water — while fish
          meal is the rendered, dried, concentrated product. A species-named meal like salmon meal
          is nutrient- and protein-dense and contributes more finished-product protein per ingoing
          pound than whole fish. Generic &quot;fish meal&quot; is less transparent than a
          species-named meal.
        </p>
