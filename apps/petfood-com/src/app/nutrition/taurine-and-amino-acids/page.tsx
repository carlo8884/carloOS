  ...
  return (
    ...
    >
      <div className="carloOS-article">
        ...
        <DropCap>
          Protein is a delivery vehicle for amino acids. The biological value of a protein source
          depends on whether it supplies all the essential amino acids in proportions matching the
          animal&apos;s needs. A protein missing or short in one essential amino acid limits the
          use of all the others — the limiting-amino-acid principle. This is why protein quality,
          not just quantity, determines how well a diet supports the animal.
        </DropCap>
        ...
        <PullQuote
          quote="The discovery of taurine-deficiency DCM in cats in the late 1980s led to mandatory taurine supplementation of cat foods and is one of the great successes of veterinary nutrition."
          variant="inline"
        />

        <CalloutBox variant="evidence" title="AAFCO taurine requirement — canned vs dry">
          <p>The AAFCO Cat Food Nutrient Profile sets a higher taurine minimum for canned cat food (0.2% dry matter for adult maintenance) than for dry food (0.1% dry matter), reflecting processing-related losses and differences in bioavailability between wet and dry formats. Manufacturers supplement accordingly to meet the respective minimums.</p>
        </CalloutBox>
        ...
        <ArticleSourcesList
          ...
          sources={[
            {
              label: 'AAFCO Official Publication — Dog and Cat Food Nutrient Profiles including amino-acid and taurine minima (Chapter 4)',
              url: 'https://www.aafco.org/resources/publications/',
              publisher: 'Association of American Feed Control Officials, 2025',
            },
            {
              label: 'Nutrient Requirements of Dogs and Cats — amino-acid biochemistry, taurine essentiality, species differences',
            ...
            {
              label: 'FDA Investigation into Potential Link Between Certain Diets and Canine Dilated Cardiomyopathy (updated June 2019)',
            ...
            {
              label: 'Taurine deficiency and dilated cardiomyopathy in golden retrievers fed commercial diets',
              url: 'https://doi.org/10.1371/journal.pone.0209112',
              publisher: 'Kaplan JL et al., PLoS ONE, 2018; 13(12):e0209112',
            },
          ]}
        />
