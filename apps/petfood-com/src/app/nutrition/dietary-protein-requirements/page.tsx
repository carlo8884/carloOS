...
export const metadata: Metadata = buildMetadata({
  siteId: 'petfood-com',
  title: 'Dietary Protein Requirements — Dogs and Cats | PetFood.com',
  description:
  ...
  return (
    ...
    >
      <div className="carloOS-article">
        ...
        <h2 id="cats">Cats — Obligate Carnivores</h2>
        <p>Cats have a higher absolute protein requirement than dogs and a limited ability to downregulate the hepatic enzymes that catabolize protein. Even when dietary protein is scarce, a cat continues to use amino acids for gluconeogenesis at a high rate, which is why protein-restricted diets are riskier for cats than for dogs. The AAFCO Cat Food Nutrient Profile sets a minimum crude protein of 30 percent dry-matter for adult maintenance and 30 percent for growth and reproduction, against the dog figures below. Cats also have specific requirements — taurine, arginine, and the sulfur amino acids — at levels that animal protein meets readily and plant protein meets poorly. A cat fed a predominantly plant-protein diet requires careful supplementation. See <a href="/species/dog-vs-cat-nutrition-overview">Dog vs Cat Nutrition</a>.</p>
        <h2 id="dogs">Dogs — Facultative Omnivores</h2>
        ...
        <ol>
          ...
          <li>Check the AAFCO statement for the correct life stage — growth and reproduction carry higher protein minima than adult maintenance.</li>
        </ol>
