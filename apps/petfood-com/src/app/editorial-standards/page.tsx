...
export const metadata: Metadata = buildMetadata({
  siteId: 'petfood-com',
  title: 'Editorial Standards | PetFood.com',
  description: 'PetFood.com editorial standards — how we research, source, and review our content.',
...
const breadcrumbSchema = buildBreadcrumbSchema({
  items: [
    ...
    { name: 'Editorial Standards', url: 'https://petfood.com/editorial-standards' },
  ],
})
...
export default function EditorialStandardsPage() {
  ...
  return (
    <>
      ...
      <p>PetFood.com is a reference publication. The editorial standards below explain how we research, source, fact-check, and disclose interests. They are the same standards that govern every CarloOS-family site.</p>
      ...
      <h2>Authorship</h2>
      <p>Articles are bylined by the PetFood.com editorial team. Where a specific reviewer or contributor has subject-matter expertise, that credential is named in the byline. We do not impersonate clinical credentials our authors do not hold. “Editorial team” is our default attribution.</p>
      ...
      <p>PetFood.com does not own equity in any brand it reviews. Affiliate commercial relationships with named vendors are disclosed on every affected page and centrally on <Link href="/disclosure" className="text-brand-primary no-underline hover:underline">/disclosure</Link>.</p>
