    ...
    >
      <div className="carloOS-article">
        ...
        <p style={{ fontSize: '13px', color: 'var(--brand-text-light)', margin: '0 0 24px' }}>
          ...
          portfolio and must be verified on the specific product label. These are
          prescription / therapeutic veterinary diets — they are dispensed through your veterinarian
          or with a veterinary authorisation, and the specific product for your pet should be chosen
          with your vet. This catalog is informational and is not a purchase recommendation.
        </p>
