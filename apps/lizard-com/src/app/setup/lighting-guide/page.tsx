...
export const metadata: Metadata = buildMetadata({ siteId: 'lizard-com', title: 'Reptile Lighting Guide — UVB, Basking, Photoperiod | Lizard.com', description: 'Complete reptile lighting guide.', path: '/setup/lighting-guide', type: 'article' })
