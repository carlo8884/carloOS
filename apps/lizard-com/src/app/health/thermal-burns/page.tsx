...
const schema = combineSchemas(buildArticleSchema({ siteId: 'lizard-com', title: 'Thermal Burns in Reptiles', description: 'Causes, signs, and treatment of thermal burns from hot rocks and heat lamps in reptiles.', url: 'https://lizard.com/health/thermal-burns', imageUrl: '', authorName: 'Lizard.com Editorial', publishedAt: '2025-05-01T00:00:00Z', modifiedAt: '2025-05-01T00:00:00Z' ,
  citation: SOURCES,
}), buildMedicalWebPageSchema({ name: 'Thermal Burns in Reptiles', description: 'Causes, signs, and treatment of thermal burns from hot rocks and heat lamps in reptiles.', url: 'https://lizard.com/health/thermal-burns', authorName: 'Lizard.com Editorial', lastReviewed: '2025-05-01', medicalAudience: 'Caregiver' }))
export default function ThermalBurnsPage() {
  return (
    <ArticleLayout siteId="lizard-com"
      ...
      breadcrumbs={[{ name: 'Home', href: '/' }, { name: 'Reptile Health', href: '/health' }, { name: 'Thermal Burns', href: '/health/thermal-burns' }]}
      schema={schema}
      relatedLinks={[
