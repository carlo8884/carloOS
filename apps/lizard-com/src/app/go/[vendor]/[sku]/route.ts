/**
 * /go/[vendor]/[sku] — affiliate click-tracking redirect (Lizard.com).
 *
 * Looks up the vendor in apps/lizard-com/src/data/affiliate-routes.ts, fills
