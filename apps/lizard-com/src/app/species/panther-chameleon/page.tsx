...
export const metadata: Metadata = buildMetadata({ siteId: 'lizard-com', title: 'Panther Chameleon Care Guide — Locale Colors, Drip Systems & Stress | Lizard.com', description: 'Panther chameleons display stunning locale-specific colors. Arboreal, solitary, and stress-sensitive. Drip system required, no handling except necessity, cage size critical.', path: '/species/panther-chameleon', type: 'article' })
