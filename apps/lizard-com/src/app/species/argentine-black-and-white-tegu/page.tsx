...
const FAQS = [
  { question: 'How big do Argentine tegus get?', answer: 'Argentine black and white tegus reach 3.5–4.5 feet and 10–15 pounds, with a lifespan of 15–20 years. An adult needs an 8×4×4 foot enclosure at minimum — larger than most furniture — which is a major part of why this is an advanced species rather than a starter reptile.' },
  { question: 'What basking temperature does a tegu need?', answer: 'An intense basking surface of 110–130°F, generated by a cluster of halogen flood bulbs over a sturdy platform, with a cool side of 75–85°F and ambient humidity around 60–80%. High-output linear T5 UVB across a large portion of the basking zone (Ferguson Zone 3–4) is required — an under-powered UVB tube is a common cause of deformity in fast-growing young tegus.' },
  { question: 'Are tegus really as tame as dogs?', answer: 'Captive-bred, well-socialized tegus recognize their keepers, tolerate extensive handling, and show problem-solving behavior unusual among lizards — but that trust is earned through consistent, gentle, daily interaction from a young age. Even a docile tegu has a powerful bite, tail whip, and strong claws, and wild-caught or under-socialized adults can be defensive.' },
  { question: 'What do Argentine tegus eat?', answer: 'They are true omnivores whose diet shifts with age: hatchlings and juveniles are heavily insectivorous and carnivorous (insects, appropriately sized whole prey, eggs), while adults take whole prey, lean meats, eggs, insects, and a smaller proportion of fruits and vegetables. Avoid a diet dominated by lean ground meat, which drives nutritional deficiency, and supplement with calcium and a balanced multivitamin.' },
  { question: 'Do tegus hibernate?', answer: 'They brumate — a natural months-long dormancy, often through the cooler half of the year, during which they burrow, stop eating, and drastically reduce activity. A brumating tegu maintains body condition and is simply quiet and buried; a sick tegu loses weight, shows discharge, or appears distressed. Consult a reptile vet before brumating any underweight or young animal.' },
]
