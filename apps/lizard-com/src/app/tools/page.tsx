...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Free reptile-keeping calculators: UVB distance estimator with Ferguson Zone targets, enclosure-size minimums, and husbandry references.',
  path: '/tools',
})
...
const TOOLS = [
  {
    ...
    desc: 'Minimum and recommended enclosure dimensions per species, with single- and group-housing scaling and species-specific husbandry notes.',
    tag: 'Housing',
  },
]
      ...
      <section className="bg-brand-dark px-container-sm sm:px-container py-section relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-lg text-white/55 leading-relaxed max-w-2xl">
            Free, source-cited reptile-keeping calculators. UVI estimation from the Ferguson Zone framework, enclosure-size minimums from ARAV / keeper literature, with explicit methodology and the limits of a rule-of-thumb estimator vs. a calibrated reading.
          </p>
        </div>
      </section>
